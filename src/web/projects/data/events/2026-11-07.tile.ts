...
Es gibt nicht nur die Möglichkeit, eure Sachen zu verkaufen oder neues Equipment zu erstehen, sondern auch mit uns ins Gespräch zu kommen und euch für unsere Kurse und Ausfahrten anzumelden.`;

export const SKIBOERSE_TILE: InfoTile = {
    id: 'skiboerse-2026',
    order: 2,
    type: TileType.Info,
    ...
    location: 'Ort: Altes Schulhaus in Hülen',
    timeData: ['9:30 Uhr bis 11:30 Uhr Annahme', '13:00 Uhr bis 14:30 Uhr Verkauf', '14:30 Uhr bis 15:00 Uhr Abholung'],
};
