...
@Injectable()
export class GymInformationProviderService
  implements GymInformationProviderServiceInterface
{
    ...
    return of<GymInformation[]>([
      {
        ...
        description:
          'Fitness / Gymnastik für Jedermann - findet ganzjährig statt, ausser in den Ferien',
