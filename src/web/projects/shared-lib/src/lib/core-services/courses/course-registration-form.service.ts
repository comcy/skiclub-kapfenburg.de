...
import { CoursesRegistrationFormServiceInterface } from 'projects/shared-lib/src/lib/components/courses';

@Injectable()
export class CourseRegistrationFormService
  implements CoursesRegistrationFormServiceInterface
{
...
export const courseRegistrationServiceProvider = {
  provide: CoursesRegistrationFormServiceInterface,
